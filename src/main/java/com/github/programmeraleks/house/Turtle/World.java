...
public class World extends JComponent implements ModelDisplay
{
  ...
  private int[] grassX = {0,600,600,0};
  private int[] grassY = {450,450,600,600};
  private int[] cloudX = {225,225,200,200,120,120,50,50,100,100,150,150};
  private int[] cloudY = {200,170,170,180,180,165,165,140,140,110,110,200};
  private int[] skyX = {0,600,600,0};
  private int[] skyY = {0,0,450,450};
  ...
  public synchronized void paintComponent(Graphics g) {
    ...
    g.fillPolygon(skyX, skyY, skyX.length);
   ...
   */
  public void modelChanged() {if (autoRepaint) {repaint();}}
